...
static void ggml_compute_forward_add_f16_f16(
    ...
    if (nb10 == sizeof(ggml_fp16_t)) {
        for (int ir = ir0; ir < ir1; ++ir) {
            ...
            ggml_fp16_t * dst_ptr  = (ggml_fp16_t *) ((char *) tensor_data(dst)  + i3*nb3  + i2*nb2  + i1*nb1);
            ggml_fp16_t * src0_ptr = (ggml_fp16_t *) ((char *) tensor_data(src0) + i3*nb03 + i2*nb02 + i1*nb01);
            ggml_fp16_t * src1_ptr = (ggml_fp16_t *) ((char *) tensor_data(src1) + i3*nb13 + i2*nb12 + i1*nb11);
...
static struct ggml_threadpool * g_threadpool = NULL;
...
enum ggml_status ggml_graph_compute(struct ggml_cgraph * cgraph, struct ggml_cplan * cplan) {
    ...
    if (threadpool == NULL) {
        ...
        g_threadpool = threadpool = ggml_threadpool_new_impl(&ttp, cgraph, cplan);
    } else {
